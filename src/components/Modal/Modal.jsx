            ...
            <div className="relative w-auto my-6 mx-auto max-w-5xl">
              ...
              <div className="grid grid-cols-3">
                <div className="lg:col-span-2 col-span-3 bg-indigo-50 space-y-5 px-5">
                        ...
                        <fieldset className="mb-3 bg-white shadow-lg rounded text-gray-600">
                          ...
                          <label className="flex border-b border-gray-200 h-12 py-3 items-center relative bg-white">
                            ...
                            >
                              <select
                                name="country"
                                className="border-none px-3 bg-transparent flex-1 cursor-pointer  appearance-none focus:outline-none"
                              >
                  ...
                  <button
                    className=" bg-yellow-500 hover:bg-yellow-700 submit-button px-4 py-3  rounded-full text-white  w-full text-xl font-semibold transition-colors"
                    onClick={handlePayLS}
                  >
                    Pay $ {tot}
                  </button>
                ...
                <div className="col-span-1 bg-white lg:block hidden">
                  <h1 className="py-6 border-b-2 text-xl font-bold text-gray-600 px-8">
                    Order Summary
                  </h1>
                        ...
                        <div className=" h-60 md:h-42 px-6  gap-3 overflow-x-scroll scrollbar-none">
                          {items &&
                            ...
                            items.map((item) => {
                              return (
                                <li
                                  className="mt-5 grid grid-cols-6 gap-3 border-b-2 product"
                                  key={item.id}
                                >
                                  ...
                                  <div className="flex flex-col col-span-2 pt-5">
                                    <span className="text-black-600 text-md font-semi-bold">
                                      {item?.title}
                                    </span>
          ...
          <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
            <div className="relative w-auto my-8 mx-5 ">
              <div className="border-2 rounded-lg shadow-lg relative flex flex-col w-full bg-yellow-500 outline-none focus:outline-none">
                <p className="mx-5 py-5 text-xl italic font-black tracking-wide">
                  THANK YOU FOR YOUR TRUST
                </p>
                <button
                  className="pb-2 text-xl italic font-black bg-amber-200  hover:bg-amber-800 tracking-wide"
                  onClick={handlePay}
                >
                  ok
                </button>
