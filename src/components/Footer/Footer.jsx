...
<footer className="text-center lg:text-left bg-gray-100 text-gray-600">
  ...
  <div className="mx-6 py-10 text-center md:text-left">
    <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div className="">
        ...
        <p className="mb-4">
          <a href="#!" className="text-gray-600">KFC</a>
        </p>
        <p className="mb-4">
          <a href="#!" className="text-gray-600">Pizza Hut</a>
        </p>
        <p className="mb-4">
          <a href="#!" className="text-gray-600">Abu Jbarah</a>
        </p>
        <p>
          <a href="#!" className="text-gray-600">FireFly</a>
        </p>
      </div>
      <div className="">
        <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
        ...
        <p className="mb-4">
          <a href="#!" className="text-gray-600">Al-Jama'a St</a>
        </p>
        <p className="mb-4">
          <a href="#!" className="text-gray-600">Al-Madina Al-Monawara St</a>
        </p>
        <p className="mb-4">
          <a href="#!" className="text-gray-600">Abu-Nsair</a>
        </p>
        <p>
  ...
  <div className="text-center p-6 bg-gray-200">
    ...
    <a className="text-gray-600 font-semibold" href="https://tailwind-elements.com/"> WISTA.com</a>
  </div>
</footer>
  );
};
