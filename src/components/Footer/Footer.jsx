const Footer =()=>{
    ...
    <footer className="bg-white dark:bg-gray-900">
        <div className="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
            <div>
                <h2 className="mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">Home</h2>
            ...
            <div>
                ...
                <ul className="text-gray-500 dark:text-gray-400">
                    <li className="mb-4">
                        <a href="https://github.com/WISTA02" className="hover:underline">Github</a>
                    </li>
        ...
        <div className="py-6 px-4 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
            <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2022 <a href="https://github.com/WISTA02">WISTA™</a>. All Rights Reserved.
            </span>
            <div className="flex mt-4 space-x-6 sm:justify-center md:mt-0">
                ...
                <a href="https://github.com/WISTA02" class="text-gray-400 hover:text-gray-900 dark:hover:text-white">
